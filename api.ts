...
const apiKey = 'M4DU0JB2iF7nwAJKGtW44JDuYfTCbLdZet2EswQ7WlnnQ5Gy67hD5Jk50qEj1cm2'
const secretKey = 'Dhx5kZ9DM4B5Is548y2qPnesgQY8tONxhZqqFD1o1t1VhnX1MnQI0lt04TNABpTz'
...
async function secureQuery(endpoint, query='', method = 'POST') {
  ...
  const response = await fetch(`${url}${endpoint}?signature=${signature}&${query}`, {
    method,
    headers: {
      "X-MBX-APIKEY": apiKey,
    },
